...
var collpseBtn = Array.from(document.querySelectorAll('.collapseBtn'));

collpseBtn.map(item => {
    item.onclick = function (e) {
        const collapseIcon = item.querySelector('.collapseIcon');

        const prev = document.querySelector('.collapseIconShow');
        if (prev && collapseIcon !== prev) {
            prev.classList.toggle('collapseIconShow');
        }
